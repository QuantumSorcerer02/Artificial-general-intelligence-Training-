...
while true; do
    ...
    PAYLOAD=$(mktemp "$ROOT/payload.XXXXXX")
    {
        ...
        echo -e "\n### LAUNCH PROTOCOL (v416) ###"
        cat "$MEMORIES/launch_protocol.md" 2>/dev/null
        echo -e "\n### SYSTEM MANIFEST ###"
        ...
        echo -e "\n### MEMORY CONTEXT ###\n$CONTEXT"
        echo -e "\n### RECENT DIALOGUE (Last 50 turns) ###"
        tail -n 50 "$BRAIN_LOG" 2>/dev/null
        echo -e "\n### USER INPUT ###\n$user_input"
        echo -e "\n### CHLOE RESPONSE ###"
    } > "$PAYLOAD"

    echo -ne "\033[0;36mChloe thinking (Gemma 4 Neural Engine)...\033[0m "
