...
def process_input(text):
    ...
    comms_script = os.path.join(os.path.dirname(os.path.abspath(__file__)), "chloe_comms.py")
    ...
    if text.lower().startswith("sms to "):
        ...
        subprocess.Popen(["python3", comms_script, "calendar", summary, description], stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
